...
public:
	...
	*/
	bool Playable(const int position, const int player) const;
	...
	*/
	...
	CardStruct getPlayerCard(const int index, const int player) const;
	...
	*/
	...
	int drawingCounter() const { return this->v_drawingCounter; };
