...
#ifndef _DSEINS_GRAPHICS_HPP
#define _DSEINS_GRAPHICS_HPP
...
/*
	...
	bool copyPal is whether to copy the palette (default true).
*/
void drawImageDMA(int x, int y, const Image &image, bool top, bool layer, bool copyPal = true);
...
/*
	...
	bool copyPal is whether to copy the palette (default true).
*/
void drawImageSegment(int x, int y, int w, int h, const Image &image, int xOffset, int yOffset, bool top, bool layer, bool copyPal = true);
...
/*
	...
	bool copyPal is whether to copy the palette (default true).
*/
void drawImageSegmentDMA(int x, int y, int w, int h, const Image &image, int xOffset, int yOffset, bool top, bool layer, bool copyPal = true);
